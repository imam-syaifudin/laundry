...
function DetailTransaksiEdit(props) {
                ...
                <div className="col-lg-10">
                    <div className="card shadow mb-4 border-left-success" ref={scrollForm}>
                        <div className="card-header py-3 d-flex justify-content-between">
                            ...
                            <h6 className="m-0 font-weight-bold text-success text-center">Edit Detail Transaksi</h6>
                            <i className="fa-solid fa-list"></i>
                        </div>
                        <div className="card-body" >
                            ...
                            <form>
                                <div className="mb-3">
                                    ...
                                    <input type="text" className="form-control" id="exampleFormControlInput1" readOnly/>
                                </div>
                                <div className="mb-3">
